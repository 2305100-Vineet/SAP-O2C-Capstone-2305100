...
| Tool | Usage |
|------|-------|
| ChatGPT (OpenAI) | Used for understanding SAP SD concepts, process explanations, and content structuring |
| Claude (Anthropic) | Used for document formatting, report writing, README preparation, and project documentation |
